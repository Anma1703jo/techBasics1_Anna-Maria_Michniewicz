...
#maybe there is an easier way. I don't know it yet
...
who_am_i = ["Wojciech... Nowak..? Yeah, I remember.",
...
#functions now
#function for text, printing it line after line, with time.sleep and in color if needed
#I had to ask AI for help with this, because it got too complicated combining color choice, printing line after line
# and everything. But I really wanted to put the original 4 print-functions into 2
#so basically, the "for line in text" structure thingy I came up myself, but the color dic and order in f" in the print
#is with AI help
...
#thought I was doing well, but struggled with the order in the print f", so little AI help here again
...
#function for input
#once again, everything was fine, but I decided to morph the two cases of possible input a,b and c and
#only a and b together so obviously I didn't come up with ".join(valid_choices" myself
...
#I hope this is fine. It was a lot of work and I'm pretty annoyed I had to use AI this much for the functions
#I usually try to avoid it as much as possible.
